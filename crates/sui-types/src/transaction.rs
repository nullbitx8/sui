...
impl CallArg {
    pub const SUI_SYSTEM_OBJ_CALL_ARG: Self = Self::Object(ObjectArg::SUI_SYSTEM_OBJ);

    pub fn read_clock_call_arg() -> Self {
    ...
    pub fn write_clock_call_arg() -> Self {
        Self::Object(ObjectArg::SharedObject {
            id: SUI_CLOCK_OBJECT_ID,
            initial_shared_version: SUI_CLOCK_OBJECT_SHARED_VERSION,
            mutable: true,
...
impl ObjectArg {
    pub const SUI_SYSTEM_OBJ: Self = Self::SharedObject {
